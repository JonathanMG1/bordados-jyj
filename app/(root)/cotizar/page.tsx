...
const CotizarPage = () => {
  const firstProduct = information.productos[0];
  return (
    <section className="bg-white py-8 antialiased md:py-16">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <h2 className="text-xl font-semibold text-black  sm:text-2xl py-20">
          Carrito de compras
        </h2>
              ...
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 md:p-6">
                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                  ...
                  <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                    ...
                    >
                      Polera Pique 60% Algodón Manga Corta Hombre
                    </a>
            ...
            <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700  sm:p-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <dl className="flex items-center justify-between gap-4">
                    <dt className="text-base font-normal text-gray-500 dark:text-gray-400">
                      Polera pique 60% Algodon Manga Corta Hombre
                    </dt>
                  ...
                  <dl className="flex items-center justify-between gap-4">
                    <dt className="text-base font-normal text-gray-500 dark:text-gray-400">
                      Polera Pique 60% Algodón Manga Larga Hombre
                    </dt>
                    <dd className="text-base font-medium text-gray-900 ">5</dd>
                  </dl>
                ...
                <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                  ...
                  <dd className="text-base font-bold text-gray-900 ">18</dd>
                </dl>
              </div>
